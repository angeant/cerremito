...
export function PipelineIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <rect x="3" y="4" width="4" height="16" rx="1" />
      <rect x="10" y="8" width="4" height="12" rx="1" />
      <rect x="17" y="6" width="4" height="14" rx="1" />
      <path d="M7 8L10 10" strokeLinecap="round" />
      <path d="M14 12L17 10" strokeLinecap="round" />
    </svg>
  );
}
...
export function AutomationIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M5 12H3" />
      <path d="M21 12H19" />
      <path d="M17.7 6.3L19 5" />
      <path d="M5 19L6.3 17.7" />
      <path d="M6.3 6.3L5 5" />
      <path d="M19 19L17.7 17.7" />
    </svg>
  );
}
...
export function SpaceIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function RocketIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M4.5 16.5C3 18 3 21 3 21C3 21 6 21 7.5 19.5C8.32 18.68 8.32 17.32 7.5 16.5C6.68 15.68 5.32 15.68 4.5 16.5Z" />
      <path d="M12 15L9 12L11.5 6.5C12.5 4.5 14.5 3 17 3C19 3 20 4 21 6C21 8.5 19.5 10.5 17.5 11.5L12 15Z" />
      <path d="M9 12L3 18" />
      <path d="M12 15L18 21" />
